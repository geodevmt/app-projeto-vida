  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white p-6 text-center">
      ...
      <div className="mb-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="mb-6 rounded-full bg-blue-100 p-6 shadow-xl ring-4 ring-blue-50">
          <GraduationCap className="h-16 w-16 text-blue-600" />
        </div>
        <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 md:text-5xl lg:text-6xl">
          Portal <span className="text-blue-600">Projeto de Vida</span>
        </h1>
        <p className="mt-4 max-w-2xl text-lg text-gray-600">
          Plataforma oficial para envio e gestão de planos de vida e currículos da rede de ensino de Mato Grosso.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 sm:flex-row animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
        <Link href="/login">
          <Button size="lg" className="w-full sm:w-auto text-lg px-8 py-6 shadow-lg bg-blue-600 hover:bg-blue-700">
            Acessar o Sistema
      ...
      {/* Rodapé Simples */}
      <div className="mt-20 flex items-center gap-2 text-sm text-gray-400">
